...
export default function TermineBestätigung() {
    ...
    return (
        ...
        <div className='flex flex-col justify-center items-center mt-40'>
           ...
           <Link to ="/home"><button className="bg-gradient-to-r from-blue-600 via-blue-700 to-blue-600 rounded-full w-72 h-20 text-3xl text-white mx-auto cursor-pointer">
              Weiter
            </button></Link> 
        </div>
        </>
